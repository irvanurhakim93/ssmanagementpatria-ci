...
<link rel="stylesheet" href="<?= base_url('tableclickable.css') ?>">
<link rel="stylesheet" href="<?= base_url('tableborder.css') ?>">
<link rel="stylesheet" href="<?= base_url('cards.css') ?>">
<link rel="stylesheet" href="<?= base_url('collapse-data.css') ?>">
<link rel="stylesheet" href="<?= base_url('forms.css') ?>">
<link rel="stylesheet" href="<?= base_url('clearfix.css') ?>">
<link rel="stylesheet" href="<?= base_url('label-center.css') ?>">
<!-- Latest compiled and minified JavaScript -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/js/bootstrap-select.min.js"></script>
<!-- (Optional) Latest compiled and minified JavaScript translation files -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/js/i18n/defaults-*.min.js"></script>
<script type="text/javascript" src="<?= base_url('chart.js') ?>"></script>
<script src="<?= base_url('bootstrap-table-resizeable.js') ?>"></script>
